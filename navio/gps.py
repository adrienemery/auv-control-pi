...
class NavStatusMsg:
    ...
    def __str__(self):
        ...
        if (self.fixStatus == 0x00):
            Status = "no fix\n"
        elif (self.fixStatus == 0x01):
            Status = "dead reckoning only\n"
        elif (self.fixStatus == 0x02):
            Status = "2D-fix\n"
        elif (self.fixStatus == 0x03):
            Status = "3D-fix\n"
        elif (self.fixStatus == 0x04):
            Status = "GPS + dead reckoning combined\n"
        elif (self.fixStatus == 0x05):
            Status = "Time only fix\n"
